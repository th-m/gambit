...
1. Read `.agent-tasks/supabase-database-setup/feature-list.json` for the story list
2. Read `.agent-tasks/supabase-database-setup/progress.txt` for learnings (check Codebase Patterns first)
